...
merged_df.columns = ['index', 'molecule', 'fragments', 'linker', 'product', 'class', 'center1', 'center2']
merged_df = merged_df.reindex(columns=['index', 'molecule', 'fragments', 'linker', 'product', 'class', 'center1', 'center2'])

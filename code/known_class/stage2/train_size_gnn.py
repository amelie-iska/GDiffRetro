...
def main(args):
    ...
    if is_geom:
        ...
        in_node_nf = const.GEOM_NUMBER_OF_ATOM_TYPES + 10
        ## add for knownclass
        ...
        ## add for knownclass
        in_node_nf = const.NUMBER_OF_ATOM_TYPES + 10
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoints', type=str, default='code/known_class/stage2/2nd_stage_train/models/uspto_size_gnn')

...
from .dataset import MoleculeDataset, ReactionDataset, \
     key_split, scaffold_split, ordered_scaffold_split
...
__all__ = [
    ...
    "MoleculeDataset", "ReactionDataset",  "key_split", "scaffold_split", "ordered_scaffold_split",

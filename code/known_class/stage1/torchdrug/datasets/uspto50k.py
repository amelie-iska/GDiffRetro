...
class USPTO50k(data.ReactionDataset):
    ...
    Parameters:
        ...
        prepare_dataset (bool, optional): lol
        **kwargs
    """
    ...
    def __init__(self, path, as_synthon=False, verbose=1, prepare_dataset=True,  **kwargs):
        ...
        for i in indexes:
            ...
            """
                 process_fn splits reactant into several reactants (choosig reaction center)
                 in _get_difference:
                 edge_added -- when reactants are seperated we need to connect them

...
reaction_solver = core.Engine(reaction_task, reaction_dataset_train, reaction_dataset_valid,
                            reaction_dataset_test, reaction_optimizer, gpus=[1],
...
reaction_solver.save("./model/reaction_center_model_w_class.pth")
...
parser.add_argument('--linker_size_model', type=str, default='code/unknown_class/stage2/2nd_stage_train/models/uspto_size_gnn/uspto_size_gnnbest_epoch=600.ckpt')
